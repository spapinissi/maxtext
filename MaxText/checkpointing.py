...
# from multihost_dataloading import None
import numpy as np
...
def load_state_if_possible(
    ...
    if load_parameters_from_path != "":
        restored_params = load_params_from_path(
            load_parameters_from_path, abstract_unboxed_pre_state.params
        )
...
def save_params_to_path(checkpoint_dir, params):
    ...
    orbax_checkpointer.save(
        checkpoint_dir, {"params": params}, save_args=save_args, force=True
    )
